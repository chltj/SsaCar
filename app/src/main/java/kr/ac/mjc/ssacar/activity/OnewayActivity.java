...
public class OnewayActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener, View.OnKeyListener, GoogleMap.OnMarkerClickListener {
    ...
    public void drawMarker(List<LocationDto> locationList) {
        for (LocationDto location : locationList) {
            mGoogleMap.addMarker(
                    new MarkerOptions()
                            .position(new LatLng(location.getY(),
                                    location.getX()))
    ...
    public boolean onMarkerClick(@NonNull com.google.android.gms.maps.model.Marker marker) {
        ...
        Intent intent = new Intent(OnewayActivity.this, TimeSettingActivity.class);
