    ...
    public class VehicleListActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            Intent receivedIntent = getIntent(); // <-- 외부로부터 받은 intent 사용해야 함
            placeName = receivedIntent.getStringExtra("place_name");
            address = receivedIntent.getStringExtra("address");
            latitude = receivedIntent.getDoubleExtra("latitude", 0.0);
            longitude = receivedIntent.getDoubleExtra("longitude", 0.0);
